...
class Settings(BaseSettings):
    ...
    def data_dir(self) -> Path:
        return PROJECT_ROOT / "platform" / "data"

    @property
    def inbox_dir(self) -> Path:
        return PROJECT_ROOT / "platform" / "data" / "inbox"

    @property
    def processed_dir(self) -> Path:
        return PROJECT_ROOT / "platform" / "data" / "processed"

    @property
    def rejected_dir(self) -> Path:
        return PROJECT_ROOT / "platform" / "data" / "rejected"
    ...
    def frontend_dir(self) -> Path:
        return PROJECT_ROOT / "platform" / "frontend"
