...
class SupplierClient:
    ...
    # FIX BUG-016: validacion de contrato via supplier-service (mas confiable que ChromaDB)
    def check_contract(self, supplier_id: str, amount: float) -> dict:
        try:
            r = httpx.get(
                f"{self.base_url}/suppliers/{supplier_id}/check",
            ...
            return {"found": False, "contract_limit": 0.0,
                    "mode": "NO_SUPERAR", "within_limit": False,
                    "contract_fragment": "", "error": str(e)}
